 ...
 */
class Employee extends \App\Models\Employee implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Employee' . "\0" . 'manager'];
        }
     ...
     * {@inheritDoc}
     */
    public function setManager(\App\Models\Manager $manager)
    {
