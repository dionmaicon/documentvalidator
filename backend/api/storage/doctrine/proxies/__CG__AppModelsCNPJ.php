 ...
 */
class CNPJ extends \App\Models\CNPJ implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['document' => NULL, 'blacklist' => NULL, 'createdAt' => NULL, 'updatedAt' => NULL];
    ...
    {
        unset($this->document, $this->blacklist, $this->createdAt, $this->updatedAt);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'document', 'blacklist', 'createdAt', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CNPJ $proxy) {
